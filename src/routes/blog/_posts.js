...
const posts = [
  {
    ...
    html: `
	<p>We're so glad you asked! 💎 Oracle, as we know, is a just a <a href='https://github.com/metonymize-kripa/DiamondOracle/blob/master/src/python_helper_module.py'>very smart and kind program</a>. 
